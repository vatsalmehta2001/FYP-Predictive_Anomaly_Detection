...
We as members, contributors, and leaders pledge to make participation in our research project and community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.

We pledge to act and interact in ways that contribute to an open, welcoming, diverse, inclusive, and healthy community focused on advancing energy forecasting research.
...
* **Data Ethics**: Respect data privacy and usage restrictions. Never attempt to re-identify anonymized household data
* **Reproducibility**: Share methods, code, and results transparently to enable scientific validation
* **Attribution**: Properly cite all data sources, prior work, and contributions from collaborators
* **Open Science**: Contribute to the broader research community through open publication of methods and findings
...
**Community Impact**: Use of inappropriate language or other behavior deemed unprofessional or unwelcome in the research community.
