...
class AutoencoderAnomalyDetector:
    ...
    def _calculate_threshold(self, dataset: TemporalAEDataset) -> None:
        ...
        logger.info(f"Anomaly threshold set to {self.threshold:.6f} ({percentile:.1f}th percentile)")
    ...
    def predict_labels(self, data: np.ndarray, threshold_multiplier: float = 1.0) -> np.ndarray:
