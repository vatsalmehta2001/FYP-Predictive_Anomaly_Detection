...
def convert_power_to_energy(
    ...
    if len(power_watts) < 2:
        ...
        return timestamps, power_watts / 1000.0, np.full(len(power_watts), target_interval_mins)
...
def ensure_monotonic_utc_timestamps(
    ...
    df_dedupe = df_sorted.drop_duplicates(subset=[entity_col, timestamp_col], keep='first')
...
class RateLimitedSession:
    ...
    def _get_cache_path(self, url: str, headers: Dict[str, str]) -> Optional[str]:
